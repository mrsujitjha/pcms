            ...
            <div class="card rounded-0 shadow">
                <div class="card-body">
                    <table class="table-responsive  table w-auto small table-bordered table-sm" style="width:100%;height:100%;overflow-y:auto">
                        ...
                        <tbody>
                            <?php $no = 0;
                            foreach ($overallprogress as $project) : $no++; ?>
                                    ...
                                    <td colspan="12">
                                        <div class="accordian-body collapse" id="d<?= $no ?>">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <?php $pk = 0;
                                                    foreach ($pkg_progress as $pkgpro) : $pk++; ?>
                ...
                <div class="card rounded-0 shadow">
                    <div class="card-header">
                        <h5 class="card-title">
                            ...
                            Overall Progress (%) Of Major Items
                        </h5>
                    </div>
                    <div class="card-body">
                ...
                <div class="card rounded-0 shadow">
                    <div class="card-header">
                        <h5 class="card-title" style="margin-left: 20px;">
                            ...
                            <?php } ?> Plan V/S Achievement Till Date
                        </h5>
                    </div>
                    <div class="card-body">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        if (strlen($m->adate) == 10) {
                                            $msg = "Project data entry is missing.";
                                        }
                                        if ($m->per <= $m->c && strlen($m->adate) != 10) {
                                            $msg = "Milestone complition date is missing.";
                                        }
                                        if ($cdate > $mdate && strlen($m->adate) != 10 && $msg == '') {
                                            $msg = "Milestone EOT date is missing.";
                                        }
                                        ?>
                                        <td><?= $msg ?></td>
                                    </tr>
        ...
        function display_chart1() {
            ...
            <?php foreach ($viewprogress as $m) : ?>
                if (vitem == "") {
                    ...
                    vitem = vitem + ':' + '<?= $m->name ?>' + '(' + '<?= $m->unit ?>' + ')';
                }
                if (pper == "") {
                    pper = '<?= round($m->p / $m->s * 100, 2) ?>';
                } else {
                    pper = pper + ':' + '<?= round($m->p / $m->s * 100, 2) ?>';
                }
                var rgb = [Math.random() * 255, Math.random() * 256, Math.random() * 256];
                if (bgcolor == "") {
                    bgcolor = 'rgba(' + rgb + ',0.3)';
                } else {
                    bgcolor = bgcolor + ':' + 'rgba(' + rgb + ',0.3)';
                }
                if (linecolor == "") {
                    linecolor = 'rgba(' + rgb + ',1)';
                } else {
                    linecolor = linecolor + ':' + 'rgba(' + rgb + ',1)';
                }
            <?php endforeach ?>
        ...
        function display_chart2() {
            ...
            <?php foreach ($overallprogress as $m) : ?>
                ...
                if (bgplan == "") {
                    ...
                    bgplan = bgplan + ':' + 'rgba(' + rgb + ',0.3)';
                }
                if (bgacheive == "") {
                    bgacheive = 'rgba(' + rgb1 + ',0.5)';
                } else {
                    bgacheive = bgacheive + ':' + 'rgba(' + rgb1 + ',0.5)';
                }
                if (linecolor == "") {
                    linecolor = 'rgba(' + rgb + ',1)';
                } else {
