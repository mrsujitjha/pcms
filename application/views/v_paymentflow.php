...
<script type="text/javascript">
	...
	function selection() {
		...
		if (flist.length > 0) {
			document.getElementById("flowlist").value = flist + "," + myselection;
		} else {
			document.getElementById("flowlist").value = myselection;
		}
	...
	function selection2() {
		...
		if (flist.length > 0) {
			document.getElementById("flowlist2").value = flist + "," + myselection;
		} else {
			document.getElementById("flowlist2").value = myselection;
		}
