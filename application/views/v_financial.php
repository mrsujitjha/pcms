				...
				<div >
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
							...
							<?php $flowlis='';foreach ($get_pkglist as $road):?>
									<option
								...
								<?php 
								if($flowlis==''){$flowlis=$road["flow"];}else{$flowlis=$flowlis.":".$road["flow"];}							
								endforeach
								?>
							</select>
						</div>
			...
			<div class=col-md-12 style="overflow-x: auto">
				<table class="table table-hover table-bordered" id="example" ui-options=ui-options="{
					...
					<tbody style="background-color: white;">
						<?php $no=0; foreach ($get_ipc as $ipc) : $no++;?>
						...
						<div class="modal-body">
							...
							<div class="form-group row">
								...
								<div class="col-sm-7">
									...
									<?php $b = $this->session->userdata('pkgid'); foreach ($get_roadlist as $road):
										if($road["pkg"]==$b){
										?>
...
<script type="text/javascript">
	...
	function actionvalue() {	
		...
		var newid=0;
		var k=0;		
		for (k=0;k<b.length;k++){ if (b[k]==frmid){break;}}	
		if(list1.selectedIndex==0){toid=b[k-1];}else{
			if(b.length==k+1){toid="Paid"}else{toid=b[k+1]};
		}
	...
	if (b=='SPS'){document.getElementById("gen").disabled = false;document.getElementById("amt").value = 0;document.getElementById("descrip").value = 'Auto generated SPS';}
